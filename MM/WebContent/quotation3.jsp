			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li>请购管理</li>
						<li class="active"><strong>比较报价单</strong></li>
					</ol>
				</div>
													...
													<div class="table-responsive">
														<table class="table table-striped">
															<div class="col-md-4">
																<!--RFQ具体信息 -->
																<div class="form-group">
																	<label for="title">RFQ集</label> <input id="vname"
															...
															<div class="col-md-2">
																...
																<div class="form-group">
																	<label for="showMethod">购买组织</label> <input
																		id="showMethod" type="text" placeholder="输入购买组织"
																		class="form-control" />
																</div>
															...
															<div class="col-md-3">
																<div class="form-group">
																	<label for="showDuration">材料编号</label> <input
																		id="showDuration" type="text" 
																		class="form-control" placeholder="请输入材料编号"/>
																</div>
			...
			<div class="footer">
				<div class="pull-right">
					<div class="text-right">
						<button type="submit" class="btn btn-primary" id="showtoast">拒绝</button>
