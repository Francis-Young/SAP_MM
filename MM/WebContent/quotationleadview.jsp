									...
									<li>
										<div class="dropdown-messages-box">
											...
											<div class="media-body">
												...
												关注了 <strong>刘海洋</strong>. <br> <small
													class="text-muted">3 天 前- 10.06.2014</small>
											</div>
										</div>
									</li>
									<li class="divider"></li>
									<li>
										<div class="dropdown-messages-box">
											...
											<div class="media-body ">
												...
												关注了 <strong>李文俊</strong>. <br> <small
													class="text-muted">昨天下午1:21 - 11.06.2014</small>
											</div>
										</div>
									</li>
									<li class="divider"></li>
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-10">
						...
						<ol class="breadcrumb">
							...
							<li>报价单管理</li>
							<li class="active"><strong>查看报价单</strong></li>
						</ol>
					</div>
						...
						<div class="col-lg-12">
							<div class="ibox float-e-margins">
								...
								<div class="ibox-content">
									...
									<%
										String rnum = "";
										if (!(session.getAttribute("quonum") == null))
											rnum = session.getAttribute("quonum").toString();
									%>
									<div class="row">

										<div class="form-group">
											<label class="col-sm-2 control-label">报价单编号：</label>
											<div class="col-sm-2">
												<input name="quotationnum" class="form-control"
													value=<%=rnum%>>
				...
				<div>
					...
					<div class="form-group">
						<label for="message">请购描述</label> <input class="form-control"
							id="key2" type="text" placeholder="输入请购描述...">
					</div>
					...
					<div class="form-group">
						<label for="showMethod">请购小组</label> <input id="key1" type="text"
