	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<form class="m-t" role="form"
				...
				<input type='text' value='reject' name='action' hidden='true'>
				<!-- 控制表单名 -->
									...
									<div class="row">
										...
										<div class="col-md-4">
											...
											<div class="form-group">
												<label for="title">RFQ:</label> <input name="org"
													type="text" class="form-control" readonly="readonly"
													value=<%=rfq.getRfq_code()%>>
											</div>
											<div class="form-group">
												<label for="message">RFQ类型：</label> <input name="gro"
													type="text" readonly="readonly" class="form-control"
													value=<%=rfq.getRfq_type()%>>

											</div>
											<div class="form-group">
												<label for="message">供应商：</label> <input name="ccd"
													type="text" readonly="readonly" class="form-control"
													value=<%=vd.getVcode()%>><span><%=vd.getVname()%></span>
											</div>
										...
										<div class="col-md-2" style="width: 25%;">
											...
											<div class="form-group">
												<label for="showMethod">RFQ日期：</label> <input name="ccd"
													type="text" readonly="readonly" class="form-control"
													value=<%=rfq.getRfq_date().toString()%>>
											</div>
											<div class="form-group">
												<label for="showMethod">截止日期：</label> <input name="ccd"
													type="text" readonly="readonly" class="form-control"
													value=<%=rfq.getRfq_deadline()%>>
											</div>
										</div>
									</div>
																...
																<tbody>
																	...
																	<%
																		...
																		for (int i = 0; i < qilist.size(); i++) {
																			...
																			out.print(s1 + m.getMaterial_shorttext() + s4);
																			out.print(s1 + qi.getQuantity() + s4);
																			out.print(s1 + m.getMaterial_baseunit() + s4);
																			out.print(
																					"<td>" + "<i class='fa fa-calendar'></i>        " + qi.getDelivery_date().toString() + "</td>");
																			out.print(s1 + qi.getPrice().toString() + s4);
																			out.print(s1 + qi.getCurrency_unit() + s4);
																			out.print(s1 + m.getMaterial_group() + s4);
																			out.print(s1 + rfq.getRfq_plant() + s4);
																			out.print(s1 + qi.getStorageloc() + s4);
																			out.print("</tr>");
																			out.print("<script>");
				...
				<div class="footer">
					<div class="pull-right">
						<div class="text-right">
							<input type="submit" class="btn btn-primary" value="否决" /> <a
