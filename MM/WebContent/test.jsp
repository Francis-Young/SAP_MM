			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li><a>表单</a></li>
						<li class="active"><strong>高级插件</strong></li>
					</ol>
				</div>
					...
					<div class="col-lg-5">
						...
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								<h5>
									选择下拉框<small>http://harvesthq.github.io/chosen/</small>
								</h5>
							...
							<div class="ibox-content">
								...
								<div class="form-group">
									<label class="font-noraml">基本实例</label>
									<div class="input-group">
										<select data-placeholder="Choose a Country..."
											class="select2_demo_1 form-control" style="width: 350px;"
											tabindex="2">
