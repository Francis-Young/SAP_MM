<%@page import="mm.dao.RFQDao"%>
<%@page import="mm.bean.RFQ"%>
<%@page import="mm.dao.QuotationDao"%>
<%@page import="mm.bean.Quotation"%>
...
'</div>';
    ...
    td_5.innerHTML = '<input name="plant'+itemNo+'"  type="text" placeholder="输入运送工厂..." class="form-control" />';
    var td_6 = tr.insertCell(5);
    td_6.innerHTML = '<input name="storloc'+itemNo+'"  type="text" placeholder="输入仓库地点..." class="form-control" />';
    var td_7 = tr.insertCell(6);
    td_7.innerHTML = '<input name="organ'+itemNo+'"  type="text" placeholder="输入请购组织" class="form-control" />';
    
    var td_8 = tr.insertCell(7);
    td_8.innerHTML = '<input name="organ'+itemNo+'" type="text" placeholder="输入请购组织" class="form-control" />';
   
    var td_9 = tr.insertCell(8);
    td_9.innerHTML = '<input name="organ'+itemNo+'" type="text" placeholder="输入请购组织" class="form-control" />';
   
    var td_10 = tr.insertCell(9);
    td_10.innerHTML = '<input name="organ'+itemNo+'"  type="text" placeholder="输入请购组织" class="form-control" />';
    var td_11 = tr.insertCell(10);
    td_11.innerHTML = '<input name="organ'+itemNo+'"  type="text" placeholder="输入请购组织" class="form-control" />';
...
<style type="text/css">
.table-b table td{border:1px solid #808080}
</style>
...
<div class="table-b">
<table id="oTable" style="width:1600px;background-color:#F5F5F5;" bordercolor="#aaaaaa" border="1" cellpadding="0" cellpadding="2" >
<thead>
<tr>
