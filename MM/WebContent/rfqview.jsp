								...
								<div class="ibox-content">
									...
									<div>
										...
										<label class="col-sm-2 control-label"
											style="width: auto; margin-bottom: 0; padding-top: 7px">RFQ编号：:</label>
										<div class="col-md-2">
											<input name="org" type="text" readonly="readonly"
												class="form-control" value=<%=q.getRfq_num()%>>
									...
									<div>
										...
										<div class="col-md-2">
											<input name="gro" type="text" class="form-control"
												value=<%=q.getRfq_purchasing_org()%>>
										</div>
									</div>
									<div>
										<label class="col-sm-2 control-label"
											style="width: auto; margin-bottom: 0; padding-top: 7px">RFQ集合号:</label>
										<div class="col-md-2">
																...
																<tbody>
																	...
																	<%
																		...
																		for (int i = 0; i < qilist.size(); i++) {
																			...
																			out.print("<td>" + "<i class='fa fa-calendar'></i>        "
																					+ qi.getRequisition_deliverydate().toString() + "</td>");
