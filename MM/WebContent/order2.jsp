														...
														<div class="table-responsive">
															<table class="table table-striped">
																<div class="col-md-4">
																	<!--RFQ具体信息 -->
																	<div class="form-group">
																		<label for="title">材料代码:CHLO005</label>
																	</div>


																	<div class="form-group">
																		<label for="message">数量：50</label>
																	</div>
																...
																<div class="col-md-2">
																	<div class="form-group">
																		<label for="message">供应商代码：35590</label>
																	</div>
																	
																	<div class="form-group">
																		<label for="message">价格：60</label>
																	</div>
																...
																<div class="col-md-5">
																	...
																	<div class="form-group">
																		<label for="message">单位：RMB</label>
																	</div>
													...
													<form class="m-t" role="form" action="Login" method="post">
														<div class="row">
															...
															<div class="col-md-4">
																<!--请购单具体信息 -->
																<div class="form-group">
																	<label for="title">到货日期</label> <input id="vname"
																		type="text" class="form-control"
																		placeholder="输入到货日期..." />
																</div>

																<div class="form-group">
																	<label for="message">对应请购单编号</label> <input
																		class="form-control" id="vaddress" type="text"
																		class="form-control" placeholder="输入对应请购单编号 ..."></input>
																</div>
															...
															<div class="col-md-2">
																<div class="form-group">
																	<label for="showEasing">到货数量</label> <input
																		id="showEasing" type="text" placeholder="输入到货数量..."
																		class="form-control" />
																</div>
															</div>
