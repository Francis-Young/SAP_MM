				...
				<ul class="nav metismenu" id="side-menu">
					...
					<li class="active"><a href="#"><i class="fa fa-files-o"></i> <span
						...
						<ul class="nav nav-second-level collapse">
							...
							<li class="active"><a href="postpayment.jsp">付款 </a></li>
									...
									<div class="row">
										...
										<div class="col-md-2">
											<input name="org" type="text" class="form-control"
												value=<%=rfq.getRfq_purchasing_org()%>>
										...
										<div>
											...
											<div class="col-md-2">
												<input name="gro" type="text" class="form-control"
													value=<%=rfq.getRfq_purchasing_group()%>>
											</div>
										</div>
										<div>
											<label class="col-sm-2 control-label"
											...
											<div id="tab-1" class="tab-pane active">
												<div class="panel-body">
													<div style="width: 900px; overflow-x: scroll;">
														<div class="table-b" style="width: 2000px">
																	...
																	<%
																		...
																		for (int i = 0; i < qilist.size(); i++) {
																			...
																			out.print("<td><div class='input-group date'> <span class='input-group-addon'>"
																					...
																					+ qi.getDelivery_date().toString() + "' class='form-control'></div></td>");
																			out.print("<td><div class='input-group date'> <span class='input-group-addon'>"
